...
function Calendar(a, b, c, d, f) {
    this.id = a, this.size = b, this.labelSettings = c, this.colors = d, this.initday = 0, f = f || {}, this.indicator = !0, f.indicator != void 0 && (this.indicator = f.indicator);
    var g = document.createElement("LI");
    g.className = "list-placeholder", g.appendChild(document.createTextNode("No events on this day")), this.placeholder = g.outerHTML, f.placeholder != void 0 && (this.placeholder = f.placeholder);
    ...
    f.days != void 0 && 7 == f.days.length && (k = f.days), this.months = h, this.label = [], this.labels = [];
...
Calendar.prototype = {
    ...
    document.getElementById(this.id).innerHTML = "<style>.day.active::before { background-color: " + this.colors[1] + "; } .day.today > span { border-color: " + this.colors[1] + " !important; }</style>", document.getElementById(this.id).appendChild(c.cloneNode(!0))
    ...
    for (var a = 1; 42 >= a; a++) document.getElementById(this.id + "-day-num-" + a).innerHTML = "", document.getElementById(this.id + "-day-" + a).className = this.id + " day listed";
    ...
    this.initday = this.label.indexOf(this.label[b]);
    for (var a = 0, f = d; a < this.label.indexOf(this.label[b]); a++, f--) document.getElementById(this.id + "-day-num-" + (this.label.indexOf(this.label[b]) - a)).innerHTML = f, document.getElementById(this.id + "-day-" + (this.label.indexOf(this.label[b]) - a)).className = this.id + " day diluted";
    for (var a = 1; a <= c; a++) document.getElementById(this.id + "-day-num-" + (this.label.indexOf(this.label[b]) + a)).innerHTML = a, a == this.date.getDate() && (document.getElementById(this.id + "-day-radio-" + (this.label.indexOf(this.label[b]) + a)).checked = !0), this.date.getMonth() == this.today.getMonth() && a == this.today.getDate() && (document.getElementById(this.id + "-day-" + (this.label.indexOf(this.label[b]) + a)).className += " today");
    for (var a = c + 1, f = 1; 42 >= this.label.indexOf(this.label[b]) + a; a++, f++) document.getElementById(this.id + "-day-num-" + (this.label.indexOf(this.label[b]) + a)).innerHTML = f, document.getElementById(this.id + "-day-" + (this.label.indexOf(this.label[b]) + a)).className = this.id + " day diluted"
...
Organizer.prototype = {
    ...
    l.className = "list", l.id = this.id + "-list", k.appendChild(l.cloneNode(!0)), c.appendChild(d.cloneNode(!0)), c.appendChild(k.cloneNode(!0)), document.getElementById(this.id).appendChild(c.cloneNode(!0))
