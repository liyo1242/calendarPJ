...
Organizer.prototype.list = function(data) {
    ...
    for (var d, b = document.createElement("UL"), c = 0; c < data.length; c++) {
        ...
        var eventStr = `${sendData.title}%0a開始時間:${sendData.time}日 ${sendData.startTime}%0a結束時間:${sendData.time}日 ${sendData.endTime}%0a活動地點:${sendData.location}%0a活動內容:${sendData.text}`;
        var holyEventStr = `${sendData.title}開始時間:${sendData.time}日 ${sendData.startTime}結束時間:${sendData.time}日 ${sendData.endTime}活動地點:${sendData.location}活動內容:${sendData.text}`
