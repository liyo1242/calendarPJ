...
function Calendar(id, size, labelSettings, colors, func) {
    ...
    this.draw();
    this.update();
    // this.setOnClickListener("refreshBtn");
    // this.setOnClickListener("goToToday");
...
Calendar.prototype.draw = function() {
    ...
    for (var d = [], f = ["year", "month", "labels", "days"], g = 0; g < f.length; g++)
        if (d[g] = document.createElement("DIV"), d[g].className = f[g], "days" != f[g])
            if ("month" == f[g]) {
                ...
                refreshBtn.id = "refreshBtn", refreshBtn.className = "btn";
                var k = document.createElement("SPAN");
                k.id = this.id + "-" + f[g], d[g].appendChild(k.cloneNode(!0)), d[g].appendChild(todayBtn), d[g].appendChild(refreshBtn);
    ...
    for (var n = [], o = [], p = [], g = 0; 6 > g; g++) n[g] = document.createElement("DIV"), n[g].className = "no-gutters row";
...
function Organizer(a, b, c) {
    ...
    d.onMonthChange(function() {
        d.indicateEvents()
    }), this.setOnClickListener("days-blocks"), this.setOnClickListener("day-slider"), this.setOnClickListener("month-slider"), this.setOnClickListener("goToToday"), this.setOnClickListener("refreshToday");
}
Organizer.prototype = {
