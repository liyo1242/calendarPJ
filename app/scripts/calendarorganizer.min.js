...
Calendar.prototype.draw = function() {
    ...
    //======= cut the year and month part
        ...
        c.appendChild(yearandmonth);
        c.appendChild(d[2].cloneNode(!0));
        c.appendChild(d[3].cloneNode(!0));
    //======= cut
...
Organizer.prototype.list = function(a) {
    ...
    for (var d, b = document.createElement("UL"), c = 0; c < a.length; c++) {
        ...
        h.setAttribute("data-whatever",a[c].text);
        ...
        //dbtn.on('tap', function() { console.log('g') ; alert('雄哥')});
        //dbtn.on('click', function() {alert('123')});
