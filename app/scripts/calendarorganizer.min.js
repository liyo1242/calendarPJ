...
Organizer.prototype.list = function(data) {
    ...
    for (var d, b = document.createElement("UL"), c = 0; c < data.length; c++) {
        ...
        var st = moment(`${sendData.time}日 ${sendData.startTime}`);
        var end = moment(`${sendData.time}日 ${sendData.endTime}`);
        ...
        var holyEventStr = `${sendData.title}開始時間:${Star}結束時間:${EndStar}活動地點:${sendData.location}活動內容:${sendData.text}`
