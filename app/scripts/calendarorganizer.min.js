...
Organizer.prototype.list = function(a) {
    ...
    for (var d, b = document.createElement("UL"), c = 0; c < a.length; c++) {
        ...
        var eventStr = `${sendData.title}%0a開始時間:${sendData.time} ${sendData.startTime}%0a結束時間:${sendData.time} ${sendData.endTime}%0a地點:${sendData.location}%0a活動內容:${sendData.text}`;
        // var UTF8str = encodeURIComponent(eventStr);
        // var toBotUrl = `https://line.me/R/oaMessage/@upo7574o/?${UTF8str}`;

        lineTransfer.href = `https://line.me/R/msg/text/?${eventStr}`
