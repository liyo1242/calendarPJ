...
Organizer.prototype.list = function(a) {
    ...
    for (var d, b = document.createElement("UL"), c = 0; c < a.length; c++) {
        ...
        lineTransfer.style = "width: 50px; background-image: url(https://uxwing.com/wp-content/themes/uxwing/download/10-brands-and-social-media/share-square.png); background-size: 100%;"
