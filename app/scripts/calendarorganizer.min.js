...
function Calendar(a, b, c, d, f) {
    this.id = a,
    this.size = b,
    this.labelSettings = c,
    this.colors = d,
    this.initday = 0,
    f = f || {},
    this.indicator = !0,
    f.indicator != void 0 && (this.indicator = f.indicator);
    var g = document.createElement("LI");
    g.className = "list-placeholder",
    g.appendChild(document.createTextNode("No events on this day")),
    this.placeholder = g.outerHTML,
    f.placeholder != void 0 && (this.placeholder = f.placeholder);
    ...
    f.days != void 0 && 7 == f.days.length && (k = f.days),
    this.months = h,
    this.label = [],
    this.labels = [];
...
Calendar.prototype.update = function() {
    ...
    var b = new Date(this.date.getFullYear(),
        this.date.getMonth(), 1).getDay(),
        c = new Date(11 < this.date.getMonth() + 1 ? this.date.getFullYear() + 1 : this.date.getFullYear(),
    ...
    for (var a = 0, f = d; a < this.label.indexOf(this.label[b]); a++, f--)
    ...
    for (var a = 1; a <= c; a++)
        document.getElementById(this.id + "-day-num-" + (this.label.indexOf(this.label[b]) + a)).innerHTML = a,
    ...
    for (var a = c + 1, f = 1; 42 >= this.label.indexOf(this.label[b]) + a; a++, f++)
        document.getElementById(this.id + "-day-num-" + (this.label.indexOf(this.label[b]) + a)).innerHTML = f,
        document.getElementById(this.id + "-day-" + (this.label.indexOf(this.label[b]) + a)).className = this.id + " day diluted"
},
...
Organizer.prototype.list = function(a) {
    ...
    for (var d, b = document.createElement("UL"), c = 0; c < a.length; c++) {
        ...
        dbtn.className = "action-d" , dbtn.id = a[c].id ;
        //========================================

        dbtn.addEventListener('click', function() { console.log('g') ; alert('雄哥') } ) ;

        //========================================
        var ubtn = document.createElement("BUTTON");


        ubtn.className = "action-u" , ubtn.id = a[c].id ,
