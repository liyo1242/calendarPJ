...
module.exports.reply = (req, res, next) => {
  ...
  var fuckyoulabUrl = `line://msg/text/?${req.body.summary}%0a開始時間%3a${fuckyouStart}%0a結束時間%3a${fuckyouEnd}%0a活動地點%3a${req.body.location}%0a活動內容%3a${req.body.description}%0=========================%0a轉傳到Cubee bot%0ahttps://line.me/R/oaMessage/@upo7574o/?${req.body.summary}開始時間%3a${spfuckyouStart}結束時間%3a${spfuckyouEnd}活動地點%3a${req.body.location}活動內容%3a${req.body.description}`;
